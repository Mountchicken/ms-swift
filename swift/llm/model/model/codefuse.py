    ...
    ModelMeta(
        ...
        [
            ModelGroup(
                [
                    Model(
                        "codefuse-ai/CodeFuse-QWen-14B", "codefuse-ai/CodeFuse-QWen-14B"
                    ),
                ]
            ),
        ],
...
def get_model_tokenizer_codellama(
    model_dir: str,
    ...
    **kwargs
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        model_dir, use_fast=False, trust_remote_code=True, legacy=False
    )
