    ...
    ModelMeta(
        ...
        [
            ModelGroup(
                [
                    Model(
                        "AI-ModelScope/WizardLM-2-8x22B", "alpindale/WizardLM-2-8x22B"
                    ),
                ]
            )
        ],
...
def get_model_tokenizer_mistral_2503(
    model_dir: str,
    ...
    **kwargs
    ...
    kwargs["automodel_class"] = (
        kwargs["automodel_class"] or Mistral3ForConditionalGeneration
    )
    model, processor = get_model_tokenizer_multimodal(
...
def get_model_tokenizer_devstral_2505(
    model_dir: str,
    model_info: ModelInfo,
    model_kwargs: Dict[str, Any],
    load_model: bool = True,
    **kwargs
    ...
    tokenizer_dir = safe_snapshot_download(
        "mistralai/Mistral-Small-3.1-24B-Instruct-2503", download_model=False
    )
