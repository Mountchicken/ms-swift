    ...
    **kwargs,
    ...
    try:
        ...
        model.transformer.registered_causal_mask = (
            model.transformer.registered_causal_mask.cuda()
        )
...
def get_model_tokenizer_qwen_audio(
    model_dir: str,
    model_info: ModelInfo,
    model_kwargs: Dict[str, Any],
    load_model: bool = True,
    **kwargs,
    ...
    tokenizer_cls: Type[PreTrainedTokenizerBase] = get_class_from_dynamic_module(
        class_ref, model_dir
    )
        ...
        [
            ...
            ModelGroup(
                [
                    ...
                    Model(
                        "Qwen/CodeQwen1.5-7B-Chat-AWQ", "Qwen/CodeQwen1.5-7B-Chat-AWQ"
                    ),
                ],
                tags=["coding"],
            ),
            ...
            ModelGroup(
                [
                    ...
                    # awq-int4
                    Model(
                        "Qwen/Qwen2-0.5B-Instruct-AWQ", "Qwen/Qwen2-0.5B-Instruct-AWQ"
                    ),
                    Model(
            ...
            ModelGroup(
                [
                    # instruct
                    Model(
                        "Qwen/Qwen2-Math-1.5B-Instruct", "Qwen/Qwen2-Math-1.5B-Instruct"
                    ),
                    Model("Qwen/Qwen2-Math-7B-Instruct", "Qwen/Qwen2-Math-7B-Instruct"),
                    Model(
                        "Qwen/Qwen2-Math-72B-Instruct", "Qwen/Qwen2-Math-72B-Instruct"
                    ),
                    # base
            ...
            ModelGroup(
                [
                    ...
                    Model(
                        "Qwen/Qwen2.5-14B-Instruct-1M", "Qwen/Qwen2.5-14B-Instruct-1M"
                    ),
                ]
            ),
            # other
        ...
        [
            ...
            ModelGroup(
                [
                    ...
                    Model(
                        "Qwen/Qwen2.5-3B-Instruct-AWQ", "Qwen/Qwen2.5-3B-Instruct-AWQ"
                    ),
                    Model(
                    ...
                    Model(
                        "Qwen/Qwen2.5-72B-Instruct-AWQ", "Qwen/Qwen2.5-72B-Instruct-AWQ"
                    ),
                ]
            ),
            # qwen2.5-coder
...
def get_model_tokenizer_qwen2_vl(*args, **kwargs):
    ...
    kwargs["automodel_class"] = (
        kwargs["automodel_class"] or Qwen2VLForConditionalGeneration
    )
    ...
    tokenizer.global_vars = (
        global_vars  # In order to have different hashes for the template.
    )
    return model, tokenizer
        ...
        [
            ModelGroup(
                [
                    ...
                    # awq-int4
                    Model(
                        "Qwen/Qwen2-VL-2B-Instruct-AWQ", "Qwen/Qwen2-VL-2B-Instruct-AWQ"
                    ),
                    Model(
                        "Qwen/Qwen2-VL-7B-Instruct-AWQ", "Qwen/Qwen2-VL-7B-Instruct-AWQ"
                    ),
                    Model(
...
def get_model_tokenizer_qwen2_5_vl(*args, **kwargs):
    ...
    kwargs["automodel_class"] = (
        kwargs["automodel_class"] or Qwen2_5_VLForConditionalGeneration
    )
...
def _forward_qwen3_vl_or_qwen3_omni(
    ...
    if pixel_values is None and pixel_values_videos is None:  # plain-text
        ...
        inputs_embeds = (
            inputs_embeds + image_embeds.mean().to(device=inputs_embeds.device) * 0.0
        )
        ...
        mixed_embeds, deepstack_visual_embeds = self.visual(
            pixel_values_mixed, grid_thw=grid_thw
        )
        if pixel_values is None:
            image_embeds = None
        ...
        if image_embeds is not None and video_embeds is not None:
            deepstack_image_embeds = [
                tensor[:image_tokens] for tensor in deepstack_visual_embeds
            ]
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        inputs_embeds, visual_pos_masks, deepstack_visual_embeds = (
            _forward_qwen3_vl_or_qwen3_omni(
                self,
                processor,
                input_ids,
                inputs_embeds,
...
def get_model_tokenizer_qwen3_vl(model_dir, *args, **kwargs):
    ...
    kwargs["automodel_class"] = (
        kwargs["automodel_class"] or Qwen3VLForConditionalGeneration
    )
        ...
        [
            ModelGroup(
                [
                    ...
                    Model(
                        "Qwen/Qwen3-VL-2B-Instruct-FP8", "Qwen/Qwen3-VL-2B-Instruct-FP8"
                    ),
                    Model(
                    ...
                    Model(
                        "Qwen/Qwen3-VL-4B-Instruct-FP8", "Qwen/Qwen3-VL-4B-Instruct-FP8"
                    ),
                    Model(
                        "Qwen/Qwen3-VL-4B-Thinking-FP8", "Qwen/Qwen3-VL-4B-Thinking-FP8"
                    ),
                    Model("Qwen/Qwen3-VL-8B-Instruct", "Qwen/Qwen3-VL-8B-Instruct"),
                    Model("Qwen/Qwen3-VL-8B-Thinking", "Qwen/Qwen3-VL-8B-Thinking"),
                    Model(
                        "Qwen/Qwen3-VL-8B-Instruct-FP8", "Qwen/Qwen3-VL-8B-Instruct-FP8"
                    ),
                    Model(
                        "Qwen/Qwen3-VL-8B-Thinking-FP8", "Qwen/Qwen3-VL-8B-Thinking-FP8"
                    ),
...
def get_model_tokenizer_qwen3_moe_vl(model_dir, *args, **kwargs):
    ...
    require_version("qwen_vl_utils>=0.0.14")
    kwargs["automodel_class"] = (
        kwargs["automodel_class"] or Qwen3VLMoeForConditionalGeneration
    )
    kwargs["_check_qwen_vl_utils"] = False
    model, processor = get_model_tokenizer_qwen2_vl(model_dir, *args, **kwargs)
...
def get_model_tokenizer_qwen2_5_omni(model_dir, *args, **kwargs):
    ...
    kwargs["automodel_class"] = (
        kwargs["automodel_class"] or Qwen2_5OmniForConditionalGeneration
    )
    processor = Qwen2_5OmniProcessor.from_pretrained(model_dir, trust_remote_code=True)
    kwargs["tokenizer"] = processor.tokenizer
    kwargs["model_config"] = Qwen2_5OmniConfig.from_pretrained(
        model_dir, trust_remote_code=True
    )
    global_vars = patch_qwen_vl_utils(vision_process)
...
def _compat_qwen3_omni_mixed_data(model, processor):
    ...
    def forward(
        ...
        **kwargs,
        ...
        inputs_embeds, visual_pos_masks, visual_embeds_multiscale = (
            _forward_qwen3_vl_or_qwen3_omni(
                self,
                processor,
                input_ids,
        ...
        if input_features is None:
            input_features = input_ids.new_zeros(
                [1, 128, 128], dtype=self.audio_tower.dtype
            )
...
def get_model_tokenizer_qwen3_omni(model_dir, *args, **kwargs):
    ...
    kwargs["automodel_class"] = (
        kwargs["automodel_class"] or Qwen3OmniMoeForConditionalGeneration
    )
    processor = Qwen3OmniMoeProcessor.from_pretrained(model_dir, trust_remote_code=True)
    kwargs["tokenizer"] = processor.tokenizer
    kwargs["model_config"] = Qwen3OmniMoeConfig.from_pretrained(
        model_dir, trust_remote_code=True
    )
    kwargs["model_config"].thinker_config.audio_token_id = processor.tokenizer.encode(
        "<|audio_pad|>"
    )[0]
    global_vars = patch_qwen_vl_utils(vision_process)
    processor.global_vars = global_vars
...
def get_model_tokenizer_qwen2_audio(*args, **kwargs):
    ...
    kwargs["automodel_class"] = (
        kwargs["automodel_class"] or Qwen2AudioForConditionalGeneration
    )
...
register_model(
    ModelMeta(
        ...
        [ModelGroup([Model("AIDC-AI/Marco-o1", "AIDC-AI/Marco-o1")])],
        ...
        if hasattr(model.visual_tokenizer, "backbone"):
            ...
            if hasattr(backbone, "vision_model"):
                patch_get_input_embeddings(
                    model.visual_tokenizer, "backbone.vision_model.embeddings"
                )
            elif hasattr(backbone, "preprocessor"):
                patch_get_input_embeddings(
                    model.visual_tokenizer, "backbone.preprocessor.patchifier"
                )
    try:
        # fix device_map
...
def get_model_tokenizer_ovis2_5(*args, **kwargs):
    ...
    if model is not None:
        ...
        patch_output_clone(embedding)
        patch_get_input_embeddings(
            model.visual_tokenizer.vit, "vision_model.embeddings.patch_embedding"
        )
